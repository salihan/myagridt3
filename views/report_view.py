...
class ReportView:
    ...
    def render(self):
        df_farm = self.home_model.get_data()

        select_farm_no = df_farm['Farm_No']
        selected_farm_no = st.sidebar.selectbox("Farm Number", select_farm_no)
        ...
        if selected_farm_no == 1:
            ...
            df_target = pakchoi_model.load_target_data()
            ...
            df_prediction = pakchoi_model.load_prediction_data()
        ...
        with tab4:
            ...
            with col[0]:
                ...
                speedometer_EC.update_layout(height=400)
